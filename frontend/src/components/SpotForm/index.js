...
const SpotForm = () => {
    ...
    useEffect(() => {
        ...
        if (!image1 || !(image1?.name?.toLowerCase()?.endsWith('.jpg') || image1?.name?.toLowerCase()?.endsWith('.img') || image1?.name?.toLowerCase()?.endsWith('.png') || image1?.name?.toLowerCase()?.endsWith('.jpeg') || image1?.name?.toLowerCase()?.endsWith('.gif'))) errors.push('Image 1 - Input a valid image ending with either a .jpg, .jpeg, .img, .png, or .gif');
        if (!image2 || !(image2?.name?.toLowerCase()?.endsWith('.jpg') || image2?.name?.toLowerCase()?.endsWith('.img') || image2?.name?.toLowerCase()?.endsWith('.png') || image2?.name?.toLowerCase()?.endsWith('.jpeg') || image2?.name?.toLowerCase()?.endsWith('.gif'))) errors.push('Image 2 - Input a valid image ending with either a .jpg, .jpeg, .img, .png, or .gif');
        if (!image3 || !(image3?.name?.toLowerCase()?.endsWith('.jpg') || image3?.name?.toLowerCase()?.endsWith('.img') || image3?.name?.toLowerCase()?.endsWith('.png') || image3?.name?.toLowerCase()?.endsWith('.jpeg') || image3?.name?.toLowerCase()?.endsWith('.gif'))) errors.push('Image 3 - Input a valid image ending with either a .jpg, .jpeg, .img, .png, or .gif');
        if (!image4 || !(image4?.name?.toLowerCase()?.endsWith('.jpg') || image4?.name?.toLowerCase()?.endsWith('.img') || image4?.name?.toLowerCase()?.endsWith('.png') || image4?.name?.toLowerCase()?.endsWith('.jpeg') || image4?.name?.toLowerCase()?.endsWith('.gif'))) errors.push('Image 4 - Input a valid image ending with either a .jpg, .jpeg, .img, .png. or .gif');
        if (!image5 || !(image5?.name?.toLowerCase()?.endsWith('.jpg') || image5?.name?.toLowerCase()?.endsWith('.img') || image5?.name?.toLowerCase()?.endsWith('.png') || image5?.name?.toLowerCase()?.endsWith('.jpeg') || image5?.name?.toLowerCase()?.endsWith('.gif'))) errors.push('Image 5 - Input a valid image ending with either a .jpg, .jpeg, .img, .png, or .gif');
